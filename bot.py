...
async def profile_command(message: Message):
    ...
    player_name = user['first_name'] if user['first_name'] else f"ID {user_id}"
...
async def menu_main_cb(query: CallbackQuery):
    ...
    player_name = user['first_name'] if user['first_name'] else f"ID {query.from_user.id}"
